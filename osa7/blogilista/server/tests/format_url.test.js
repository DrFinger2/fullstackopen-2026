...
describe('formatUrl()', () => {
  ...
  describe('Invalid URLs', () => {
    const invalidCases = [
      ...
      {
        input: 'sub.example',
        desc: 'single word domain with subdomain (no TLD)',
      },
      ...
      {
        input: 'sub.www.example.com',
        desc: 'www used as a non-leading subdomain',
      },
      {
        input: 'ww.example.com',
        desc: 'segment with all "w"s that is not "www"',
      },
      ...
      {
        input: 'example.unknown-gtld-that-does-not-exist',
        desc: 'unsupported gTLD',
      },
